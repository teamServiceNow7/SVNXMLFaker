...
#Main Function 
def main():
    # Initialize session state for modified XML
    if 'modified_xml' not in st.session_state:
    ...
    if uploaded_files:
        ...
        if selected_file:
            st.session_state.file_name = selected_file.name
            ...
            if update_button:
                st.session_state.modified_xml = save_modified_xml(tree)
                
                st.sidebar.download_button(
                    label="Download Modified XML",
                    data=st.session_state.modified_xml,
                    file_name=file_name,
